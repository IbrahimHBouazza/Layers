            ...
            <h2 className="text-6xl font-medium mt-6 text-center max-w-xl mx-auto">Questions? We've got {" "} 
                ...
                <div className="mt-12 flex flex-col gap-6 max-w-xl mx-auto">
                    {faqs.map((faq, faqIndex) => (
                        <div key={faq.question} className="bg-neutral-900 rounded-2xl
                        border-white/10 border p-6">
                            <div className="flex justify-between items-center">
                                ...
                                className={twMerge("feather feather-plus text-lime-400 flex-shrink-0", selectedIndex === faqIndex && "hidden", selectedIndex === faqIndex && "rotate-45")}>
